...
2. **Search the whole codebase** for the same anti-pattern (`rg` / `grep` /
...
3. **Document the root cause in one paragraph** in the dossier before writing any
   fix. If you can't explain it in a paragraph, you don't understand it yet.
4. Optional quality-scan gate: run a code-quality / complexity scanner on the
